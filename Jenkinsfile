node {
    ...
    stage('EmailNotification'){
        mail bcc: 'thotibanuchandra@gmail.com', body: '''Build is Over.

Regards
Banuchandra,
8297354748''', cc: 'thotibanuchandra@gmail.com', from: '', replyTo: '', subject: 'Build is Over.', to: 'thotibanuchandra@gmail.com'
